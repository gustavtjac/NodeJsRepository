...
/beers  GET   Gets all beers
/beers/{id}  GET   Get an singular beer resource
/beers  POST  adds a new beer resource
/beers/{id}  PUT   changes a whole beer resource
/beers/{id} PATCH  Changes parts of beer resource
/beers/{id} DELETE deletes a beer resource
